...
<body class="sticky-header">
        			...
        			<div class="col-lg-12">
            			<div class="hpanel">
		                	...
		                	<div class="panel-body">
		                		<div class="row">
        	    					<div class="col-lg-12">
        	    						<form class="form-horizontal" action="admin/proj/role/list.htm" method="get">
                                 			...
                                 			<c:forEach items="${pager.list}" var="roleInfo" varStatus="status">
                                 				<tr>
		                                        	...
		                                        	<td>${roleInfo.name}</td>
		                                         	...
		                                         	<td class="actions">
		                                         		<shiro:hasPermission name="projRoleMgr:forwardPrivSet">
			                                         		<a class="btn btn-sm btn-success" href="admin/proj/role/forwardPrivSet.htm?roleId=${roleInfo.id}">
    ...
    <script type="text/javascript" src="js/admin/projRoleList.js"></script>
    <!-- END FOOTER SECTION -->
</body>
</html>
