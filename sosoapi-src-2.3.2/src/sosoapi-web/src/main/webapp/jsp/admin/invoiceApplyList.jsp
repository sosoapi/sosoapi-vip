...
<body class="sticky-header">
        			...
        			<div class="col-lg-12">
            			<div class="hpanel">
		                	...
		                	<div class="panel-body">
		                		<div class="row">
        	    					<div class="col-lg-12">
        	    						<form class="form-horizontal" action="admin/invoice/apply/list.htm" method="get">
							                <div class="form-group">
							                	<label class="control-label col-lg-offset-1 col-lg-2">邮箱</label>
							                	<div class="col-lg-2">
							                	...
							                	<div class="col-lg-2">
							                		<input type="text" name="companyName" value="${param.companyName}" class="form-control">
							                	</div>
							                </div>
							                
							                <div class="form-group">
							                	<label class="control-label col-lg-offset-1 col-lg-2">处理状态</label>
							                	<div class="col-lg-2">
		                                        	...
		                                        	<td>${applyInfo.type.displayName}</td>
		                                         	...
		                                         	<td class="actions">
		                                         		...
		                                         		<c:if test="${applyInfo.dealStatus == 'undeal' or applyInfo.dealStatus == 'reject'}">
	                                                   	...
	                                                   	<c:if test="${applyInfo.dealStatus == 'dealing'}">
	                                                   		<button type="button" onclick="initApproveOper(${applyInfo.id},'${applyInfo.userEmail}');" class="btn btn-sm btn-success" data-toggle="modal" data-target="#applyFormModal">
							...
							<div class="modal-dialog">
								<div class="modal-content">
											...
											<div class="col-lg-12">
												<form id="applyForm" role="form" class="form-horizontal">
													...
													<div class="form-group apply-info-group">
														...
														<label class="control-label col-lg-2">用户邮箱</label> 
														<div class="col-lg-4 valid-group">
															<input id="userEmail" name="email" class="form-control apply-info"/>
														</div>
													</div>
									...
									<div class="modal-footer">
										...
										<button id="approveBtn" type="button" class="btn btn-success approve-info-group">审批</button>
    ...
    <script type="text/javascript" src="js/admin/invoiceApplyList.js"></script>
    <!-- END FOOTER SECTION -->
</body>
</html>
