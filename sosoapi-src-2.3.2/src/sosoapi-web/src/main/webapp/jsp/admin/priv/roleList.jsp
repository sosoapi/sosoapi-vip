...
<head>
	...
	<title>角色管理  ${Cfg.WEB_PAGE_TITLE_POSTFIX}</title>
...
<body class="sticky-header">
        			...
        			<div class="col-lg-12">
            			<div class="hpanel">
		                	...
		                	<div class="panel-body">
		                		<div class="row">
        	    					<div class="col-lg-12">
        	    						<form class="form-horizontal" action="admin/role/list.htm" method="get">
                                 			...
                                 			<c:forEach items="${pager.list}" var="roleInfo" varStatus="status">
                                 				<tr>
		                                        	...
		                                        	<td>${roleInfo.name}</td>
		                                         	...
		                                         	<td class="actions">
														<shiro:hasPermission name="roleMgr:forwardPrivSet">
															<a class="btn btn-sm btn-success" href="admin/role/forwardPrivSet.htm?roleId=${roleInfo.id}">
		                                                   		<i class="fa fa-filter"></i> 权限配置
		                                                   	</a>
														</shiro:hasPermission>
			                                                   	
	                                         			<button type="button" onclick="initUpdateOper(${roleInfo.id});" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#roleFormModal">
	                                                   		<i class="fa fa-pencil"></i> 编辑
	                                                   	</button>
	                                                   	
	                                                   	<button type="button" onclick="initDelOper(${roleInfo.id});" class="btn btn-sm btn-danger" ${roleInfo.delDisabled ? 'disabled="disabled"' : ''}>
    ...
    <script type="text/javascript" src="js/admin/priv/roleList.js"></script>
    <!-- END FOOTER SECTION -->
</body>
</html>
