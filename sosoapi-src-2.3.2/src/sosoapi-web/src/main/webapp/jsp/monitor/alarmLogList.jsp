...
<head>
	...
	<title>警报日志列表  ${Cfg.WEB_PAGE_TITLE_POSTFIX}</title>
        			...
        			<div class="col-lg-12">
            			<div class="hpanel">
		                	...
		                	<div class="panel-body">
		                		<form class="form-horizontal" action="auth/monitor/alarm/log/list.htm" method="get">
                                 			...
                                 			<c:forEach items="${pager.list}" var="logInfo" varStatus="status">
                                 				<tr>
		                                        	...
		                                        	<td>${logInfo.monitorName}</td>
		                                         	...
		                                         	<td class="actions">
		                                         		<shiro:hasPermission name="monitorAlarmLog:view">
		                                         			<a type="button" href="auth/monitor/alarm/log/info.htm?logId=${logInfo.id}" class="btn btn-sm btn-primary">
