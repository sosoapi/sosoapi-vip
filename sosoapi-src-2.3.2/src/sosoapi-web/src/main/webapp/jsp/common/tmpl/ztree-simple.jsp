...
<body class="blank">
		...
		<div class="row">
		    <div class="col-lg-6">
		        <div class="hpanel">
		            ...
		            <div class="panel-body">
						<div>
							<ul id="treeSimpleDataDemo" class="ztree"></ul>
						</div>
		            </div>
		        </div>
		    </div>
		    ...
		    <div class="col-lg-6">
		        <div class="hpanel">
		            ...
		            <div class="panel-body">
						<div>
							<ul id="treeStandarDataDemo" class="ztree"></ul>
						</div>
		            </div>
		        </div>
		    </div>
	...
	$(function () {
    	$.fn.zTree.init($("#treeSimpleDataDemo"), simpleDataSetting, simpleDataNodes);
    	
    	$.fn.zTree.init($("#treeStandarDataDemo"), standardDataSetting, standardDataNodes);
    });
    </script>
    <!-- END FOOTER SECTION -->
</body>
