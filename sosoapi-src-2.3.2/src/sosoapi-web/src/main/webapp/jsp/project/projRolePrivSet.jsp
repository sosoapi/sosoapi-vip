...
<head>
	...
	<title>项目角色权限设置  ${Cfg.WEB_PAGE_TITLE_POSTFIX}</title>
...
<body class="sticky-header">
            			...
            			<div class="hpanel">
                			<div class="panel-heading">
			                    <div class="panel-tools pannel-tools-fixed">
									...
									<a href="auth/proj/role/list.htm?projId=${param.projId}&docId=${param.docId}" type="button" class="btn btn-default">取消</a>
    ...
    <script type="text/javascript" src="js/project/projRolePrivSet.js?v=1.0.0"></script>
    <!-- END FOOTER SECTION -->
</body>
</html>
