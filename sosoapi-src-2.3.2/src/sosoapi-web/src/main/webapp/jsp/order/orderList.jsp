...
<head>
	...
	<title>购买记录  ${Cfg.WEB_PAGE_TITLE_POSTFIX}</title>
        			...
        			<div class="col-lg-12">
            			<div class="hpanel">
		                	...
		                	<div class="panel-body">
		                		<!-- SEARCH SECTION -->
		                        <form class="form-horizontal" action="auth/order/list.htm" method="get">
					                <div class="form-group">
					                	...
					                	<label class="control-label col-lg-2">查询区间</label>
