...
<body>
    ...
    <div class="content">
        <form action="auth/pay/ali/direct/buildReq.htm" class="alipayform" method="POST" target="_blank">
            ...
            <div class="element">
                ...
                <div class="einput"><input type="text" name="subName" value="test商品123"></div>
                <br>
			...
			<div class="element">
                ...
                <div class="einput"><input type="text" name="subDesc" value="即时到账测试"></div>
                <br>
