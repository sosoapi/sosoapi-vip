...
function initForm(){
	...
	$("#saveRoleBtn").click(function(){
		if(isFormValid("roleForm")){
			...
			var msg = "";
			if(operType == "add"){
				reqUrl = "admin/proj/role/json/add.htm";
				msg = "新增成功";
			}
			else if(operType == "update"){
				reqUrl = "admin/proj/role/json/update.htm";
				msg = "保存成功";
			}
...
function initUpdateOper(id){
	...
	doGet("admin/proj/role/json/info.htm","roleId=" + id,function(roleInfo){
...
function initDelOper(id){
	bootbox.confirm("确定执行删除操作？",function(){
		...
		param.roleId = id;
		doPost("admin/proj/role/json/del.htm",param,function(data){
