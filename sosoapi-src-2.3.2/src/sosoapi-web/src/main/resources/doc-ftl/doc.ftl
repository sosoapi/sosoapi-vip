...
#content{margin-top:1.25em;margin-left:30px;}
...
table.tableblock{max-width:100%;border-collapse:separate;table-layout:fixed;width:900px;}
...
/* 自定义样式 */
.doc-title{margin-top:1.25em;margin-left:30px;padding-left:.9375em;}
