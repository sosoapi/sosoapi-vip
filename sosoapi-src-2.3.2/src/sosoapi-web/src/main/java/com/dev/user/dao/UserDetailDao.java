...
public interface UserDetailDao extends BaseMybatisDao<UserDetail,Long> {
	 ...
	 * 
			...
			*@CreateDate 2015年9月12日上午10:59:16
	 */
	Map getDetailByEmail(String email);
	...
	List<Map> listAll(@Param("email")String email,@Param("nickName")String nickName,
						@Param("valid")Boolean valid,@Param("roleId")Long roleId,
	 ...
	 */
	void updateAmountInfo(@Param("userId")Long userId,@Param("increaseFeeAmount")Integer increaseFeeAmount,
							@Param("increaseInvoiceAmount")Integer increaseInvoiceAmount);
}
