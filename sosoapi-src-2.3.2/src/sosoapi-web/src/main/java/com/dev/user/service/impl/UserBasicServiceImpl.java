...
public class UserBasicServiceImpl extends BaseMybatisServiceImpl<UserBasic,Long,UserBasicDao>
	...
	@Override
	public int countTotalRegist(Long roleId) {
		return getMybatisDao().countTotalRegist(roleId);
	}
	...
	@Override
	public int countDayRegist(Date dayStart,Date dayEnd) {
		return getMybatisDao().countDayRegist(dayStart,dayEnd);
	}
	...
	public void sendUpdateEmailCode(Long userId,String passwd, String email) {
		...
		String code = CryptUtil.encryptAES(JsonUtils.toJson(info),CfgConstants.SECURITY_SECRET_KEY);
	...
	public void updateEmail(String code) {
		Map<String, Object> updateInfo = JsonUtils.toObject(CryptUtil.decryptAES(code,CfgConstants.SECURITY_SECRET_KEY), HashMap.class);
	...
	public void updateRole(Long userId, Long roleId) {
		getMybatisDao().updateRole(userId, roleId);
	}
}
