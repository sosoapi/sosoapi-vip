...
public enum SchemaType {
	...
	/** 字符串*/
	sys_string_date("date","string","date"),
	
	/** 字符串*/
	sys_string_datetime("datetime","string","date-time"),
	...
	public static SchemaType getByType(String type,String format){
		...
		SchemaType result = SchemaType.sys_string;
		if (StringUtils.isEmpty(type)) {
			return result;
		}
		
		//特殊处理
		String specialType = type.toLowerCase();
		if (specialType.equals("string") && StringUtils.isEmpty(format)) {
			return SchemaType.sys_string;
		}
		else if (specialType.equals("int")) {
			return SchemaType.sys_integer_int32;
		}
		else if(specialType.equals("long")){
			return SchemaType.sys_integer_int64;
		}
		else if (specialType.equals("float")) {
			return SchemaType.sys_number_float;
		}
		else if (specialType.equals("double")) {
			return SchemaType.sys_number_double;
		}
		else if (specialType.equals("decimal")) {
			return SchemaType.sys_number_decimal;
		}
		else if(specialType.equals("bool")){
			return SchemaType.sys_boolean;
		}
