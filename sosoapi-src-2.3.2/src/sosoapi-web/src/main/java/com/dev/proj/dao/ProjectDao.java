...
public interface ProjectDao extends BaseMybatisDao<Project,Long> {
	 ...
	 */
	List<Map> listAll(@Param("name")String name,@Param("code")String code,
						@Param("email")String email,@Param("status")ProjectStatus status,
						@Param("memMinCount")Integer memMinCount,@Param("memMaxCount")Integer memMaxCount,
	 ...
	 */
	int countAll(@Param("name")String name,@Param("code")String code,
			@Param("email")String email,@Param("status")ProjectStatus status,
			@Param("memMinCount")Integer memMinCount,@Param("memMaxCount")Integer memMaxCount);
