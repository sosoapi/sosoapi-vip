...
public class Swagger {
    ...
    /** 错误码*/
    protected List<ApiErrorCodeInfo> errorCodes;
    /** 环境*/
    protected List<ApiEnvInfo> apiEnvs;
    /** 公共请求参数*/
    protected List<Parameter> commonParams;
	...
	public List<ApiErrorCodeInfo> getErrorCodes() {
		return errorCodes;
	}

	public void setErrorCodes(List<ApiErrorCodeInfo> errorCodes) {
		this.errorCodes = errorCodes;
	}

	public List<ApiEnvInfo> getApiEnvs() {
		return apiEnvs;
	}

	public void setApiEnvs(List<ApiEnvInfo> apiEnvs) {
		this.apiEnvs = apiEnvs;
	}
