...
CREATE TABLE `t_book` (
  ...
  `open` tinyint(4) DEFAULT NULL COMMENT '是否公开',
  `share` tinyint(4) DEFAULT NULL COMMENT '是否开启分享',
  ...
  `sort_weight` int(11) DEFAULT NULL COMMENT '排序权重',
  `pub_status` varchar(16) DEFAULT NULL COMMENT '发布状态',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='书籍设置';
...
CREATE TABLE `t_book_chapter` (
  ...
  `content_link` varchar(256) DEFAULT NULL COMMENT '内容链接',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='书籍章节';
...
CREATE TABLE `t_book_content` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='书籍内容';
...
CREATE TABLE `t_goods` (
  ...
  `pub_status` varchar(16) DEFAULT 'on' COMMENT '发布状态',
  PRIMARY KEY (`id`)
...
-- ----------------------------
-- Table structure for t_invoice_apply
-- ----------------------------
DROP TABLE IF EXISTS `t_invoice_apply`;
CREATE TABLE `t_invoice_apply` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `create_date` datetime DEFAULT NULL COMMENT '创建时间',
  `modify_date` datetime DEFAULT NULL COMMENT '修改时间',
  `user_id` bigint(20) DEFAULT NULL COMMENT '用户id',
  `type` varchar(16) DEFAULT NULL COMMENT '发票类型',
  ...
  `company_tel` varchar(32) DEFAULT NULL COMMENT '公司电话',
  `company_bank_name` varchar(256) DEFAULT NULL COMMENT '公司开户银行',
  `company_bank_account` varchar(32) DEFAULT NULL COMMENT '公司开户银行账号',
  `mailing_addr` varchar(256) DEFAULT NULL COMMENT '邮寄地址',
  `receiver_name` varchar(32) DEFAULT NULL COMMENT '收件人姓名',
  `receiver_tel` varchar(32) DEFAULT NULL COMMENT '收件人电话',
  `apply_remark` varchar(256) DEFAULT NULL COMMENT '申请备注信息',
  ...
  `mailing_serv_name` varchar(32) DEFAULT NULL COMMENT '快递商名称',
  `mailing_no` varchar(32) DEFAULT NULL COMMENT '快递单号',
  `mailing_date` datetime DEFAULT NULL COMMENT '寄送时间',
  `remark` varchar(256) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='发票申请';

-- ----------------------------
-- Records of t_invoice_apply
-- ----------------------------
...
CREATE TABLE `t_privilege` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=901 DEFAULT CHARSET=utf8mb4 COMMENT='资源权限';
...
INSERT INTO `t_privilege` VALUES ('14', '2017-07-04 16:33:49', '2017-07-04 16:33:49', '删除消息', '', 'admin/msg/json/del.htm', 'oper', '7', 'msgMgr:del', 'on', '1', '1', 'none', '', null, null, 'user');
...
INSERT INTO `t_privilege` VALUES ('900', '2017-11-23 11:43:19', '2017-11-23 11:43:21', '其他文档', '19', 'auth/book/tree/list.htm', 'menu', null, 'bookTree:list', 'on', '1', '10', 'none', 'fa fa-book', null, null, 'proj');
...
CREATE TABLE `t_sys_cfg` (
  ...
  `def_val` varchar(512) DEFAULT '' COMMENT '默认值',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb4 COMMENT='系统参数';

-- ----------------------------
-- Records of t_sys_cfg
-- ----------------------------
INSERT INTO `t_sys_cfg` VALUES ('1', '2017-07-18 15:11:25', '2017-07-18 16:00:44', '邮件设置', 'mailSetting', '', 'on', '0', '20', 'cate', '用于配置发送邮件时，内部的标题等信息', '');
...
INSERT INTO `t_sys_cfg` VALUES ('6', '2017-07-18 15:17:03', '2017-07-18 16:00:37', '站点设置', 'siteSetting', '', 'on', '0', '10', 'cate', '用于设置网站相关功能开关', '');
...
INSERT INTO `t_sys_cfg` VALUES ('12', '2017-07-18 15:25:52', '2017-07-18 15:25:55', '监控设置', 'monitorSetting', null, 'on', '0', '30', 'cate', '用于监控功能相关设置', '');
...
INSERT INTO `t_sys_cfg` VALUES ('14', '2017-07-18 15:29:06', '2017-07-18 15:29:08', '项目设置', 'projSetting', null, 'on', '0', '40', 'cate', '接口管理相关配置', '');
...
INSERT INTO `t_sys_cfg` VALUES ('16', '2017-07-18 16:01:07', '2017-07-18 16:01:09', 'SEO设置', 'seoSetting', null, 'on', '0', '50', 'cate', 'seo相关设置', '');
...
INSERT INTO `t_sys_cfg` VALUES ('22', '2018-06-01 17:47:30', '2018-06-01 17:47:30', 'mock跨域自定义头部', 'mock.cors.header.cust', '', 'on', '14', '30', 'item', '用于处理mock请求时有自定义请求header的ajax跨域问题', null);
...
CREATE TABLE `t_user_detail` (
  ...
  `fee_amount` int(11) DEFAULT '0' COMMENT '总费用金额',
  `invoice_amount` int(11) DEFAULT '0' COMMENT '发票金额',
  PRIMARY KEY (`id`),
...
-- ----------------------------
INSERT INTO `t_user_detail` VALUES ('1', '2016-10-18 16:46:02', '2016-10-18 16:46:02', '1', null, null, null, null, null, null, 'admin', null, null, null, '0', '0');
