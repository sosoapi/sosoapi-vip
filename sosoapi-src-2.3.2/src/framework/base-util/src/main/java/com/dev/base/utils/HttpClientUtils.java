...
public class HttpClientUtils {
    ...
    public static String doGet(String url,Map<String, Object> paramMap,String charset){
    	return doGet(url, paramMap,null, charset);
    }
     ...
     * 
    		...
    		*@Time 创建时间:2015年4月23日下午1:24:16
     */
    public static String doGet(String url,Map<String, Object> paramMap,Map<String, String> headerMap, String charset){
    	HttpGet get = new HttpGet(buildUrl(url, paramMap,charset));
    ...
    public static String doPost(String url,Map<String, Object> paramMap, String charset){
    	return doPost(url, paramMap, null, charset);
    }
     ...
     * 
    		...
    		*@Time 创建时间:2015年4月23日下午1:25:12
     */
    public static String doPost(String url,Map<String, Object> paramMap,Map<String, String> headerMap, String charset){
    	HttpPost post = new HttpPost(url);
		if (!CollectionUtils.isEmpty(paramMap)) {
			try {
				HttpEntity httpEntity = new UrlEncodedFormEntity(parseParams(paramMap), charset);
    ...
    public static String doPostJson(String url,Map<String, Object> urlParams,String json){
    	return doPostJson(url, urlParams, null, json);
    }
     ...
     * 
    		...
    		*@Time 创建时间:2015年5月7日下午4:57:53
     */
    public static String doPostJson(String url,Map<String, Object> urlParams,Map<String, String> headerMap,String json){
...
//        FileInputStream instream = new FileInputStream(new File(certFilePath));
        ...
        try {
        	instream = ResourceUtils.loadSingle(certFilePath).getInputStream();
